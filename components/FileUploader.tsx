  ...
  return (
    <div {...getRootProps()} className='file-upload'>
        ...
        { files && files?.length > 0 ? (
            <Image src={convertFileToUrl(files[0])} width={1000} height={1000} alt='upload image' className='max--[400px] overflow-hidden object-cover'/>
        ) : (
            <>
                <Image src='/assets/icons/upload.svg' width={40} height={40} alt='upload'/>
                <div className="file-upload_label">
                    <p className="text-a14-regular">
