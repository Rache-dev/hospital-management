...
const RenderField = ({ field, props }:{field : any ; props: CustomProps}) => {
    ...
    switch (fieldType) {
        ...
        case FormFieldType.PHONE_INPUT:
            return (
                <FormControl>
                    <PhoneInput onChange={field.onChange} className="input-phone shad-input border-0" international defaultCountry="US" placeholder={placeholder} value={field.value as E164Number | undefined}/>
                </FormControl>
            )
        ...
        case FormFieldType.DATE_PICKER:
            return (
               <div className="flex rounded-md border border-dark-500 bg-dark-400">
                ...
                <FormControl>
                    <ReactDatePicker selected={field.value} onChange={(date) => field.onChange(date)} dateFormat={dateFormat ?? 'MM/dd/yyy'} showTimeSelect={showTimeSelect ?? false}
            ...
            return (
                <FormControl>
                    <div className="flex items-center gap-4">
                        <Checkbox placeholder={placeholder} {...field} id={props.name} checked={field.value} onCheckedChange={field.onChange} />
